...
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="#"><i style='color:#000e2e;' class="icon-home"></i></a>
</li>
...
<div class="body">
<p class="alert alert-danger" style='color:white; border:none; background:#000e2e;'>Wallet Balance: <span style="font-weight: 600; font-size: 20px;"> $<?php echo  $walletbal;?></span></p>
<form method="post" action="../scripts/depositdrivescript.php" onsubmit="return checkamountbal_1()" name='myform_1'>

<br>
<p style='font-family: Georgia, serif;'>Min Deposit: $50,000</p>

<p style='font-family: Georgia, serif;'>Max Deposit : Unlimited</p>


<p style='font-family: Georgia, serif;'>Duration:   10% After 30 Days 
<!-- After 5 Hours  -->
</p>
