...
}else if(amountinvestnumber > 9999){

swal("Error!", "Maximum investment is $9,999", "error");
return false;
...
<div class="card">
<div class="header">
<h2 style='color:#000e2e; font-family: Georgia, serif;'> Deluxe    Plan</h2> <br>
...
<br>
<p style='font-family: Georgia, serif;'>Min Deposit: $5,000 </p>

<p style='font-family: Georgia, serif;'>Max Deposit : $9,999 </p>

<p style='font-family: Georgia, serif;'>Duration:   6% Daily For 14 Days 
<!-- After 8 Hours   -->
</p>
...
<input type="text" name="invest_amount" value="" class="form-control " placeholder="Enter Amount" oninput="seconinvest()">

<input type="hidden" name="plan" value="Deluxe">
