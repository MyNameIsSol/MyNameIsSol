...
}else if(amountinvestnumber < 100 ){
swal("Error!", "Minimum investment is $100", "error");
return false;
...
<div class="card">
<div class="header">
<h2 style='color:#000e2e; font-family: Georgia, serif;'> Basic  Plan</h2> <br>
...
<br>
<p style='font-family: Georgia, serif;'>Min Deposit: $100</p>

<p style='font-family: Georgia, serif;'>Max Deposit : $4,999</p>


<p style='font-family: Georgia, serif;'>Duration:  4% Daily For 5 Days
<!-- After 10 Hours   -->
</p>
...
<input type="text" name="invest_amount" value="" class="form-control " placeholder="Enter Amount" oninput="investone()">
...
<br>
<button type="submit" style='border:none; background:#000e2e;' name="invest" class="btn btn-block btn-success">Invest</button>
</form>
</div>
</div>
</div>
