	...
	function addseven(){
		...
		if($result_checker > 0){
			...
			// CALCULATION
			 ...
			 // $realearnprofit = number_format($secondcal,1);


			 if($statusofdep == "Processing" && $count >= 1){
...
mail($to, $subject, $message, $headers);
       	...
       	SET profit='$secondcal',count = '$countingdays'
...
mail($to, $subject, $message, $headers);
		...
		if($result_checker > 0){
			...
			$totalamountearning = $earns + $secondcal;
       	...
       	SET earns='$totalamountearning',walletbal='$amount',totalwith ='$investvalue'
