	...
	function addsevenp(){
		...
		if($result_checker > 0){
			...
			// CALCULATION
			 ...
			 if($statusofdep == "Processing" && $count >= 10){
...
$message.= "</div> ";
$message .=  "<p style='text-align:center;'><span style='color:rgb(253, 150, 26);'>Profit Orients </span>  © 2015-2021 All Rights Reserved</p> ";
$message.=  " </div>";
$message.=  "</div>";
$message.=  "</body></html>";
