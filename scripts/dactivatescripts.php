<?php
        ...
        $message.=  "<h3 style='padding: 1px;font-family: Georgia; text-align:center; color:white;'>DE-ACTIVATION</h3>";
        $message.=  "</div>";
        ...
        $message.="<p style='font-family:Arial, Helvetica, sans-serif;'> Your Investment Account has been suspended due to some reasons, Kindly visit the support service for support and help.</p>";
        ...
        header("Location:../admindash.php?dactivate=success");
                exit();
