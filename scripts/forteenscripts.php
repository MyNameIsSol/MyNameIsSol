	...
	function addsevenf(){
		...
		if($result_checker > 0){
			...
			// CALCULATION
			 ...
			 if($statusofdep == "Processing" && $count >= 5){
...
$message.=  "<h3 style='padding: 1px;font-family: Georgia;'><span style='color:rgb(253, 150, 26);'>Profit Orients Trading Firm</span>PAY</h3>";
...
$message.="<p>from Profit Orients PAY</p>";
...
$message.=  "<div style='width:90%; height: auto; margin: auto;margin-top: 20px;box-shadow: 0px 0px 3px rgb(253, 150, 26);border-radius: 5px;'>";
$message.=  "<div style='width:100%;'>";
$message.=  "<h3 style='padding: 1px;font-family: Georgia;'><span style='color:rgb(253, 150, 26);'>Profit Orients</span>PAY</h3>";
$message.=  "<h4 style='padding: 1px;'>Dear ".$usd.",</h4> ";
$message.= " <br>";
$message.=  "<div style='width:100%;height: auto;box-shadow: 0px 0px 3px rgb(253, 150, 26);margin: auto;border-radius: 6px;'>";
...
$message.="<p>from Profit Orients</p>";


$message.= "</div> ";
$message .=  "<p style='text-align:center;'><span style='color:rgb(253, 150, 26);'>Profit Orients </span>PAY  © 2020 All Rights Reserved</p> ";
$message.=  " </div>";
$message.=  "</div>";
$message.=  "</body></html>";
