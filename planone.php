              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="myInput" width="100%" cellspacing="0" style="color:black">
                  ...
                  <div class="hpanel">
                    ...
                    <form method="POST" action="scripts/changeadminpwds.php">
                            
                            <input type="text" name="chp" placeholder="Enter New Admin Password" class="form-control">
                            <br>

                            <input  type="submit" name="chan" value="CHANGE">
